...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Oct 14, 2025 at 06:20 AM
...
--
-- Table structure for table `etre_responsable`
--
...
INSERT INTO `rapport_visite` (`VIS_MATRICULE`, `RAP_NUM`, `RAP_DATEVISITE`, `RAP_BILAN`, `RAP_AUTRE`, `RAP_MOTIF`, `etat_code`, `PRA_NUM`) VALUES
('a131', 1, '2002-04-18', 'Médecin curieux, à recontacter en décembre pour réunion.', NULL, NULL, NULL, 23),
('a131', 2, '2003-03-23', 'RAS.\r\nChangement de tel : 05 89 89 89 89.', NULL, NULL, NULL, 41),
('a131', 3, '2021-12-03', 'Médecin énervé, ancien boxeur !', NULL, NULL, NULL, 7),
('a17', 1, '2003-05-21', 'Changement de direction, redéfinition de la politique médicamenteuse, recours au générique.', NULL, NULL, NULL, 4);
...
ALTER TABLE `avoir`
  ...
  ADD CONSTRAINT `avoir_rapport_FK` FOREIGN KEY (`VIS_MATRICULE`,`RAP_NUM`) REFERENCES `rapport_visite` (`VIS_MATRICULE`, `RAP_NUM`);
...
--
-- Constraints for table `etre_responsable`
--
...
ALTER TABLE `offrir`
  ...
  ADD CONSTRAINT `offrir_rapport_FK` FOREIGN KEY (`VIS_MATRICULE`,`RAP_NUM`) REFERENCES `rapport_visite` (`VIS_MATRICULE`, `RAP_NUM`);
...
ALTER TABLE `presenter`
  ...
  ADD CONSTRAINT `presenter_rapport_FK` FOREIGN KEY (`VIS_MATRICULE`,`RAP_NUM`) REFERENCES `rapport_visite` (`VIS_MATRICULE`, `RAP_NUM`);
